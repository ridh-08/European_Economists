...
let state = "start"; // start, quiz, feedback, end
...
function drawStartScreen() {
  ...
  textFont('Verdana');
  textSize(24);
  text("Welcome to Quiz on European Economists!", width / 2, height / 2 - 40);
  textSize(16);
  text("Click anywhere to start your challenge.", width / 2, height / 2 + 20);
}
...
function drawFeedbackScreen() {
  ...
  textSize(16);
  textWrap(WORD);
  text(`${economist.info}`, width / 2 - 250, height / 2, 500);
  textSize(16);
  text("Click anywhere to continue.", width / 2, height / 2 + 90);
}

function drawEndScreen() {
  textAlign(CENTER, CENTER);
  textSize(24);
  text("Congratulations! You've completed the quiz!", width / 2, height / 2 - 40);
  textSize(16);
